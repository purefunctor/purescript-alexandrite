...
export function bifunctorWrapTypeType(functorFDict) {
  return (functorGDict) => {
...
export function bitraversableWrapTypeType(traversableFDict) {
  return (traversableGDict) => {
    ...
    return {
      Bifunctor0: () => /* @__PURE__ */ bifunctorWrapTypeType(/* @__PURE__ */ traversableFDict.Functor0())(/* @__PURE__ */ traversableGDict.Functor0()),
      Bifoldable1: () => /* @__PURE__ */ bifoldableWrapTypeType(/* @__PURE__ */ traversableFDict.Foldable1())(/* @__PURE__ */ traversableGDict.Foldable1()),
      bitraverse: $closure,
      bisequence: (applicativeFDict$1) => (value$1) => /* @__PURE__ */ Data_Bitraversable.bitraverse(/* @__PURE__ */ bitraversableWrapTypeType(traversableFDict)(traversableGDict))(applicativeFDict$1)((effect0) => effect0)((effect1) => effect1)(value$1)
    };
  };
}

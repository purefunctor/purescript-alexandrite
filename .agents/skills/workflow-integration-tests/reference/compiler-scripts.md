...
just t compiler --update-output [filters...] # Update generated JavaScript fixture output
```
...
|----------|-------|-------------|
| compiler | c | Checking, diagnostics, semantic recovery, functional, and JavaScript tests |
